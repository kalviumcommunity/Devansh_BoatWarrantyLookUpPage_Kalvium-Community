...
export function WrenchIcon(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14.7 6.3a4 4 0 015.6 5.6L11 21l-4-1-1-4 9.3-9.3a4 4 0 013.4-.4z" />
    </svg>
  );
}
...
export function CartIcon(props) {
  return (
    ...
    >
      ...
      <path d="M2.5 3h2l2.3 12.3a2 2 0 002 1.7h8.4a2 2 0 002-1.6L21 8H6" />
    </svg>
  );
}
...
export function ScanIcon(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3 5v14M8 5v14M12 5v14M17 5v3M17 16v3M21 5v14" />
    </svg>
  );
}
